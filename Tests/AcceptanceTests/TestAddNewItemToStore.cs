...
namespace Tests.AcceptanceTests
{
    ...
    public class TestAddNewItemToStore
    {
        ...
        [Test]      
        public async Task TestFailureInput(string name, string store, int amount, string category, string[] tags,
            double price)
        {
            string token = _auth.Connect();
            Result<string> yossiLogin = await _auth.Login(token, "Yossi11", "qwerty123", ServiceUserRole.Member);
        ...
        [Test]      
        public async Task TestFailureLogic(string name, int amount, string category, string[] tags,
        ...
        [Test]      
        public async Task TestFailureInputDoubleAddition(string name, string store, int amount, string category, string[] tags,
            double price)
        {
            string token = _auth.Connect();
            Result<string> yossiLogin = await _auth.Login(token, "Yossi11", "qwerty123", ServiceUserRole.Member);
